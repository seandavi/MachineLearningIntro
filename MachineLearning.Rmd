...
library(knitr)
options(width=60)
opts_chunk$set(tidy=TRUE,warning=FALSE,message=FALSE,fig.width=9,fig.height=6, cache=TRUE)
```

```{r eval=FALSE}
library(BiocInstaller)
biocLite(c('mlbench','adabag', 'randomForest', 'party', 'mboost', 'rpart.plot'))
```
